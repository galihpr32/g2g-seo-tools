...
const PAGE_CONTEXTS: Record<string, string> = {
  ...
  '/knowledge-base/proposals':         'KB Rule Proposals — review queue for new rules. Sources: monthly winners-vs-losers extractor cron, "Promote to KB" buttons on briefs/experiments, manual entries. Approve to add to a chosen KB item field.',
  '/feedback':                         'Feedback — bug reports + feature requests submitted via the floating 🐛 button. Status flow: new → in_progress → resolved/wont_fix. Galih (admin) triages; submitters reply.',
